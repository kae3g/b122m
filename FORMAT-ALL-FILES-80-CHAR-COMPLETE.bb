...
;; ============================================================================
;; 💚🖤💛 FORMAT ALL FILES TO 80 CHARACTER LIMIT - COMPLETE 💚🖤💛
;; ============================================================================
...
(ns format-all-files-80-char-complete
...
(defn -main
  ...
  []
  (println "💚🖤💛 FORMATTING ALL FILES TO 80 CHARACTER LIMIT - COMPLETE 💚🖤💛")
  (println "===============================================================")
  (println "")
...
12025-09-14--0552--pacific-daylight-standard--mrigashirsha--sonomausa")
  ...
  (let [workspace-dirs ["/Users/bhagavan851c05a/b122m"
    ...
    (println "💚🖤💛 ALL FILES FORMATTED TO 80 CHARACTER LIMIT - COMPLETE 💚🖤💛")
